    ...
    <div id="app">
        ...
        <nav class="col-sm-3 col-md-1 d-none d-sm-block bg-light sidebar" style="background-color: white">
            <ul class="nav nav-pills flex-coloumn">
                <li class="nav-item">
                    <a class="nav-link active" href="/warehousemanager/public/executive/tampilBarang">Tampil Barang</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="/warehousemanager/public/executive/tampilAkun">Tampil Akun</a>
                </li>
                <li class="nav-item">
