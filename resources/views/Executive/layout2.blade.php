          ...
          <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
              <div class="navbar nav_title" style="border: 0;">
                <a href="/warehousemanager/public/executive/home" class="site_title"><span>Warehouse Manager</span></a>
              </div>
                  ...
                  <ul class="nav side-menu">
                    <li><a><i class="fa fa-home"></i>Menu<span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
                        <li><a href="{{URL::to('executive/tampilBarang') }}">Tampil Barang</i></a></li>
                        <li><a href="{{URL::to('executive/tampilAkun') }}">Tampil Akun</a></li>
                        <li><a href="{{URL::to('executive/keuangan') }}"">Keuangan</a></li>
                      </ul>
                    </li>
                </div>
